...
# the path where log and checkpoint will be
# saved(Path not hand-craft created is acceptable).
_C.TRAIN.LOG_OUTPUT_PATH = "../log/output"
# training model config file
_C.TRAIN.CONFIG_FILE_PATH = "../detectron2/configs/COCO- \
...
# training model config file
_C.TRAIN.CONFIG_FILE_PATH = "../detectron2/configs/COCO- \
    Detection/faster_rcnn_R_50_C4_3x.yaml"
# pre-train model weight
_C.TRAIN.MODEL_WEIGHTS_PATH = "detectron2://ImageNetPretrained/MSRA/R-50.pkl"

_C.TEST = CN()
# set a custom testing threshold
_C.TEST.SCORE_THRESH_TEST = 0.03
# pre-train model weight in testing
_C.TEST.MODEL_WEIGHTS_PATH_TEST = "detectron2://ImageNetPretrained \
    /MSRA/R-101.pkl"
